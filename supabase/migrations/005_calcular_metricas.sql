-- KPIs por credor/período a partir de carteira_snapshot (leitura rápida via RPC)
...
GRANT EXECUTE ON FUNCTION public.calcular_metricas_credor(UUID, DATE, DATE, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION public.calcular_metricas_credor(UUID, DATE, DATE, TEXT) TO service_role;
